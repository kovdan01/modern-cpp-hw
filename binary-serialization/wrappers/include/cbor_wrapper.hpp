#ifndef BINARY_SERIALIZATION_WRAPPERS_CBOR_WRAPPER_HPP_
#define BINARY_SERIALIZATION_WRAPPERS_CBOR_WRAPPER_HPP_
...
#endif  // BINARY_SERIALIZATION_WRAPPERS_CBOR_WRAPPER_HPP_
