...
public:
            ...
            else
            {
                ...
                else
                {
                    ...
                    case EventType::READ:
                        ...
                        {
                            event->client->handle_read(cqe->res);
                        }
                        else
                        {
                    ...
                    case EventType::WRITE:
                        event->client->handle_write(cqe->res);
                        break;
                    }
                    delete event;
                }
    ...
    void add_read_request(Client* client)
    {
        ...
        Event* event = new Event{client, EventType::READ};
    ...
    void add_write_request(Client* client, std::size_t nbytes, bool more_data)
    {
        ...
        Event* event = new Event{client, EventType::WRITE};
        io_uring_sqe_set_data(sqe, event);
        io_uring_submit(&m_ring);
    }
